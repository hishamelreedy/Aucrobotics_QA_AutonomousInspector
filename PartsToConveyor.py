...
while i >= 0:
    ...
    # Place the part at a random position with respect to the target on the conveyor
    TX = uniform(-150, 150)
    RZ = uniform(-90*pi/180, +90*pi/180)
    
    robot.MoveL(target_conv_pose*transl(TX,0,0)*rotz(RZ))
